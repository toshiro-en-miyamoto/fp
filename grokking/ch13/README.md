...
The trouble is that we want to loop over the *indices*, not the values of the array. The indices will let us slice into our original array, creating sub-arrays or "windows".
